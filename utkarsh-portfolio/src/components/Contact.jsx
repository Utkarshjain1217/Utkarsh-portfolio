          ...
          >
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center space-x-4 p-4 bg-dark rounded-lg border border-gray-800 hover:border-white transition-all duration-300 group"
              >
              ...
              <div className="flex space-x-4">
                {personalInfo.github && (
                  <a
                    ...
                    className="w-10 h-10 bg-dark border border-gray-800 rounded-lg flex items-center justify-center hover:border-white hover:text-white transition-all duration-300"
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-dark-gray border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-white transition-colors duration-300"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full px-4 py-3 bg-dark-gray border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-white transition-colors duration-300 resize-none"
